...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    await ethers.provider.send("evm_increaseTime", [5 * 24 * 60 * 60]); // 5 days
    const AttackFactory = await ethers.getContractFactory("Attacker", attacker);
    ...
    console.log(`Attacker is`, attack.address);
    await attack.connect(attacker).begin();
  });
  ...
  after(async function () {
    ...
    console.log(`Attacker got rewards of`, rewards.toString());
